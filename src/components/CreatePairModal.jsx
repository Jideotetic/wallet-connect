...
const CreatePairModal = ({ params, close }) => {
	...
	const counterInstance = StellarService.createAsset(
		counter.code,
		counter.issuer
	);
	...
	return (
		<ModalWrapper>
			...
			<Description>
				To create a pair, you first need to pay for the trustlines for
				transactions. Once it’s done, please allow up to 10 minutes for our
				systems to correctly add the new market and make it available for anyone
				to vote.
			</Description>
			<div>
				<AssetsInfo>
