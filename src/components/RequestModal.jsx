...
const STATUS_DESCRIPTION = {
	...
	[TX_STATUSES.awaitSigners]:
		"Transaction Confirmed. More signatures required to complete",
};
...
const RequestModal = ({ params, close }) => {
	...
	return (
		<ModalWrapper>
			...
			<ModalDescription>
				View and sign the transaction in {name}
			</ModalDescription>
			...
			<IconContainer>
				...
				{(status === TX_STATUSES.success ||
					status === TX_STATUSES.awaitSigners) && <IconSuccess isBig />}
			</IconContainer>
