...
const FreighterAccountChangedModal = ({ params, close }) => {
	...
	const selectNo = () => {
		if (saveChoice) {
			localStorage.setItem(
				LS_FREIGHTER_ACCOUNT_CHANGE_IMMEDIATELY,
	...
	return (
		<ModalWrapper>
			...
			<ModalDescription>
				Account was switched in the Freighter extension. Do you want to change
				the address connected to Aquarius?
			</ModalDescription>
