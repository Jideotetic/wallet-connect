...
import { flexAllCenter, respondDown } from "../web/mixins.js";
import { Breakpoints, COLORS } from "../web/styles.js";
...
const PairingModal = ({ params }) => {
	...
	return (
		<ModalWrapper>
			...
			<ModalDescription>
				Restore your connection or create a new one.
			</ModalDescription>
