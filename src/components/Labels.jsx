...
import { MAX_REWARDS_PERCENT, MIN_REWARDS_PERCENT } from "./Table";
...
export const AuthRequiredLabel = () => (
	<StyledLabel
		...
		tooltipText={
			<span>
				One of the assets in this market has flags enabled. Most assets with
				“Required”, “Revocable”, and “Clawback Enabled” flags are currently
				banned from Aquarius. Learn more about flag
				<a
