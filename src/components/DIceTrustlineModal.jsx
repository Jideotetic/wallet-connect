...
const DIceTrustlineModal = () => (
	<ModalWrapper>
		...
		<ModalDescription>
			Someone has delegated ICE to your account — a dICE payment is pending. Add
			a trustline to receive it. The dICE will be credited to your balance
			within 30 minutes, after which you’ll be able to vote on the liquidity
			voting page.
		</ModalDescription>
		<AssetBlock>
			<DIceLogo />
