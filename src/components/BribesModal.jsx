		...
		<ModalWrapper $isWide>
			...
			<BribeDetails>
				<BribeDetailsMain>
					...
					<BribeDetail>
						<BribeDetailTitle>
							Bribe per 1000 AQUA or ICE votes:
						</BribeDetailTitle>
						<BribeDetailValue>
				...
				{showHowItWorks && (
					<HowItWorks>
						<HowItWorksText>
							Bribes are divided among all participants in the voting for the
							market pair. Make sure you have an open trustline to the bribe
							reward asset to receive your share. Maximum bribe APY is displayed
							for fully locked ICE ({MAX_X_ICE_BOOST} ICE per AQUA).
						</HowItWorksText>
						<HowItWorksFooter>
