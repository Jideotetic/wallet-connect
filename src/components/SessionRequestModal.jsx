...
const SessionRequestModal = ({ params }) => {
	...
	return (
		<ModalWrapper>
			...
			<ModalDescription>
				The connection request was sent to {name}. Confirm the request in the
				app and continue with {WalletConnectService.selfMeta.name}.
			</ModalDescription>
			<IconsBlock>
				<AquaLogo />
				<Arrows />
