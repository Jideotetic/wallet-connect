...
import BribesModal from "./BribesModal";
import ManageVotesModal from "./ManageVotesModal";
...
const VoteTable = ({
	...
	const isPairSelected = ({ market_key: marketKey }) =>
	...
	const goToMarketPage = (pair) => {
		navigate.push(`${MarketRoutes.main}/${pair.asset1}/${pair.asset2}`);
	};
					...
					rowItems: [
						...
						},
						{
							children: (
								<Voted>
									{pair.voting_amount
										? formatBalance(pair.voting_amount)
										: null}
								</Voted>
							),
							label: "Users Voted:",
